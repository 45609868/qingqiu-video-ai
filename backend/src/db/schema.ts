...
export const dramas = sqliteTable('dramas', {
  ...
  coverStatus: text('cover_status').default('pending'),
...
export const episodes = sqliteTable('episodes', {
  ...
  storyboardCount: integer('storyboard_count').default(0),
...
export const characters = sqliteTable('characters', {
  ...
  imageLockStatus: text('image_lock_status'),
  referencePrompt: text('reference_prompt'),
  referenceImages: text('reference_images'),
  seedValue: text('seed_value'),
  lastUsedSeed: integer('last_used_seed'),
  consistencySeed: integer('consistency_seed'),
...
export * from './schema_additions.js'
