      ...
      <div class="header-left">
        <button class="brand" @click="navigateTo('/')">
          <div class="brand-mark">
            <img v-if="showBrandImage" :src="brandLogo" alt="清秋AI短剧" class="brand-logo" @error="showBrandImage = false" />
            <span v-else class="brand-fallback">清</span>
          </div>
          <div class="brand-text">
            <span class="brand-name">清秋AI短剧</span>
            <span class="brand-sub">qingqi.ai</span>
          </div>
        </button>
      </div>
