...
const dramas = ref<DramaSummary[]>([])
const loading = ref(false)
const showCreate = ref(false)
const form = ref<DramaForm>({ title: '', total_episodes: 1, style: '' })
const styles = ['realistic', 'anime', 'ghibli', 'cinematic', 'comic', 'watercolor', 'guofeng-xuanhuan', '3d-guoman']
...
async function create() {
  ...
  try {
    const d = await dramaAPI.create(form.value) as DramaSummary
...
async function delDrama(d: DramaSummary) {
...
function getProgress(d: DramaSummary) {
